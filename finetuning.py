...
#TODO
'''
- rejig the file name and hyperparameter names, but make sure norm_type is part of the model's name when it's saved
...
KSIZES = [3,7,15]
DROPS = [True,False]
MORMALIZATIONS = [True,False]#this is for batchnorm
SEED = 10
    ...
    for maxpool in MAXPOOLINGS:
        for activationLast in ACTIVATIONLASTS:
            for IMG_SIZE in IMG_SIZES:
                for norm_type in NORM_TYPES:#new
                    for loss1 in LOSSES:
                                            ...
                                            model_name = str(modelUnet.name) + "_IMG_SIZE_" + str(IMG_SIZE) + "_loss1_" + str(
                                                loss1) + "_nfilter1_" + str(
                                                    ...
                                                    + "_lr1_" + str(lr1) + "_kSize1_" + str(kSize1) + "_activationLast_" + str(
                                                        ...
                                                        + "_dropout_" + str(dp) \
                                                        + "_normtype_" + str(norm_type)#TODO make sure norm_type is part of the name, or assess_model() won't work
                                            print(model_name)
